                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr v-for="user in users" :key="user.id">
                                    <td>{{ user.Name }}</td>
                                    <td>
                                    <a :href="route('print_pdff7', { id: user.id })" class="btn btn-secondary">
                                      Print Pdf Here!
                                    </a>
                                    </td>
                                    <td>{{ user.Sex }}</td>
                                ...
                                <td>{{ user.ScienceTechnSubject }}</td>
                                    ...
                                    <td>{{ user.DateOf }}</td>
                                    <td>
                                        <a @click.prevent="deleteUseri(user.id)" class="btn btn-danger">Delete</a>
                                    </td>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <!-- Add similar headers for other subjects -->
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="user in users" :key="user.id">
                                ...
                                <!-- Add similar columns for other subjects -->
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="tab-inn">
                    <div class="table-responsive table-desi">
                        <table class="table table-hover">
                            ...
                            <tbody>
                              <tr v-for="user in usersWithPosition" :key="user.id">
