...
function calculateTotalScore($user) {
    $subjectScores = [
        optional($user)->NumerousScore,
        optional($user)->ReadingScore,
        optional($user)->WrittingScore,
        optional($user)->HealthCareScore,
        optional($user)->ArtSportScore,
...
<table>
    ...
    <?php
    $subjectScores = [
        'Numerous' => $insert->NumerousScore,
        'Reading' => $insert->ReadingScore,
        'Writting' => $insert->WrittingScore,
        'HealthCare' => $insert->HealthCareScore,
        'ArtSport' => $insert->ArtSportScore,
    ];
...
<table>
    ...
    <p><b>Class Teacher's name:</b> {{$insert->ClassTeacher}}. <b>Phone No: </b> {{$insert->PhoneNo}}.</p><br><br>
</table>
<table>
    <tr>
